...
('Race-TPR', 'Race-calibration-'),
('Race-TNR', 'Stability'),
('accuracy', 'Stability'),
('White-Male-accuracy', 'Stability'),
('Black-Male-accuracy', 'Stability'),
('CV', 'Stability'),
('TNR', 'Stability'),
('TPR', 'Stability')]

def run(dataset = get_dataset_names(), graphs = GRAPHS, filenames = None):
